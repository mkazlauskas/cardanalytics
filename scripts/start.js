...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then((port) => {
    ...
    const noWatch = process.argv.indexOf('--no-watch') > -1
    const config = configFactory('development', noWatch)
    ...
    const serverConfig = createDevServerConfig(proxyConfig, urls.lanUrlForConfig, noWatch)
